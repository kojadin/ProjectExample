...
import com.erevacation.challenge.ViewUtils;
...
public class MaterialMenuDrawable extends Drawable implements Animatable {
    ...
    public MaterialMenuDrawable(Context context, int color, Stroke stroke, int scale,
        ...
        this.width = (int) (dpToPx(resources, BASE_DRAWABLE_WIDTH) * scale) -
                resources.getDimensionPixelSize(R.dimen.burger_size_decrement);
    ...
    public void draw(Canvas canvas) {
        ...
        if (mContext.getResources().getBoolean(R.bool.isTablet)) {
            ...
            canvas.translate(0, ViewUtils.dp2px(mContext, 2));
        } else {
            canvas.save();
            canvas.scale(0.85f, 0.85f, 0, 0);
            canvas.translate(0, ViewUtils.dp2px(mContext, 2));
        }
    ...
    private final class MaterialMenuState extends ConstantState {
        ...
        public Drawable newDrawable() {
            ...
            drawable.setIconState(
                    animatingIconState != null ? animatingIconState : currentIconState);
